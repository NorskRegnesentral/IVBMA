...
helper <- function(j)
{
    ...
    pi.M <- c(rep(0.5,2), rep(1, p.W - 2), rep(0.5, p.X))
    Theories <- c(rep(1,2),rep(2,6),rep(3,p.W - 9),4,5,6,7,7,8,8,8,8,9,10,11,11,11,12,12,12,12,12,13)
    m = max(Theories)
